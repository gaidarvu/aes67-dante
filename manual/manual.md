# Инструкция по развёртыванию aes67/Dante
...
6.	Во вкладке `Sources`, при необходимости, создаём **Source**.
...
Каналы `01` и `02` мини-ПК конференции направлены на матрицу `RX7`, `RX8`.
...
В `Dante Controller` коммутируем `CH1`, `CH2` микрофона с аудиоматрицей на входы `RX3`, `RX4`, как показано на рисунке.
