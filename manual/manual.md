...
Далее в программе `TIGER D1616N` необходимо перенаправить звук с `RX3`, `RX4` на TX, которые были выбраны при создании `мультикастов` (см. Настройка мультикастов в Dante Controller)
